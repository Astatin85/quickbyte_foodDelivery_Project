...
const navItems = [
  { to: '/customer/restaurants', icon: '🏪', label: 'Restaurants' },
  { to: '/customer/cart', icon: '🛒', label: 'Cart' },
    ...
    <div className="dashboard-layout">
      <aside className="sidebar">
        ...
        <div style={{ padding: '0 4px 16px', marginBottom: 8 }}>
          <div style={{ fontSize: '0.75rem', color: 'rgba(240,240,248,0.3)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.8px', marginBottom: 8 }}>Customer</div>
        ...
        <button className="btn btn-outline btn-sm" onClick={handleLogout} style={{ width: '100%', justifyContent: 'center', marginTop: 'auto' }}>
          🚪 Logout
        </button>
      </aside>
